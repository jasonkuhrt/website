  ...
  <div id="app">
    ...
    <section className="Section">
      ...
      <p>
        ...
        functionally-oriented software engineer with over five years experience
        creating web apps and backend systems. Recently I helped lead
        development of the realtime distributed cloud system at littleBits that
        powers the cloudBit. I earned a BFA majoring in design at Concordia
        University where systems, theory, and society were foundational. I can
        get a computer to do the right thing, yet I am adept at ideation,
        interdisciplinary collaboration, design thinking, research, and
        synthesis.
      </p>
      <h2>Work With Me</h2>
      <p>
        I am currently based in Montreal and available for contract work. Feel
        free to get in touch with an opportunity or just a friendly hello!
      </p>
    </section>
    <ul>
      <li>
    ...
    <section className="Section">
      ...
      <h2>Expertise</h2>
      <p>
        I have architected a real-time cloud platform, contributed critical
        design thinking to product, and putted a humble art practice focused on
        anatomy of systems. As a design-minded generalist engineer I am equipped
        to help mediate various domain tradeoffs inherent to those
        interdisciplinary projects concerned with using technology to enhance
        the human condition.
      </p>
      <h2>Recently</h2>
      <p>
      ...
      <p>
        ...
        also built the control app where users setup, managed, and interacted
        with their cloudBit. Furthermore I helped grow the team, researched
        advanced platform features, made internal CLI tools, weighed in on
        product decisions, contributed leadership, and more.
      </p>
    </section>
    <style jsx global>{`
      html,
