...
<div class="mb-8 flex justify-between items-start flex-wrap gap-4">
  <div class="flex gap-2 flex-wrap items-center">
    {#each ['experience', 'education', 'achievement', 'speaking', 'personal'] as eventType}
      <button
        type="button"
      ...
      >
        <svelte:component this={getNodeIconComponent(eventType)} class="w-2.5 h-2.5" />
  ...
  >
    ...
    >
      ...
      <div class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
        ...
        <p>
          <strong>Time Scale</strong> toggles between evenly-spaced and chronologically-accurate layout (1 pixel = 1
          day)
        </p>
      </div>
    </div>
