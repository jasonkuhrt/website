---
title: 'Untyped JavaScript For Now'
date: 2018-01-01
---

In the last few years multiple implementations of typed JavaScript have successfully emerged, namely [TypeScript](http://www.typescriptlang.org/) and [Flow](https://flow.org/). I've followed each one loosely and played around with Flow in a few projects.

I have been using Flow in my latest project [Forto](https://github.com/jasonkuhrt/forto) for a few weeks now, but tonight that all stops as I have personally concluded typed JavaScript is a net loss for what I do with it. My conclusion has been fuelled primarily by the following three reasons: syntactic damage, project overhead and lack of tooling, not-high-enough-for-me type system expressivity. The last point is most important. Here are just two examples, but many more can be found:
